...
This model still assumes there is a single fixed correction factor that will work regardless of the concentration effect on the RR interval. Since the RR interval is being affected by the drug concentration, it is also possible that the correction factor is also being affected by the concentration. 
...
is there some typing that must happen?
